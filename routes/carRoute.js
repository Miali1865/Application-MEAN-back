...
const { getAllCars,getCarById,createCar,updateCar,deleteCar,getTotalCars } = require('../controllers/carController');
...
router.get('/total-cars', authMiddleware, roleMiddleware(["manager"]), getTotalCars);
